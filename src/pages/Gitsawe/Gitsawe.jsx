        ...
        days: [
            ...
            },
            {
                ...
                content: [
                    ...
                    { title: "ቅዳሴ", main: " የእመቤታችን #የማርያም_ቅዳሴ ነው። መልካም የእመቤታችን የተዓምር በዓል፣ የነብዩ ቅዱስ ኢዩኤል የዕረፍት በዓል፣ የቅዱስ አልዓዛር የሥጋው ፍልሰት፣ የቅዱስ አላኒቆስ የዕረፍት በዓል እና የጾም ጊዜ ለሁላችንም ይሁንልን።" }
                ]
            },
            {
                id: 22,
            ...
            },
            {
                ...
                content: [
                    ...
                    { title: "ምስባክ", main: " ወታቀንተኒ ኃይለ በጸብእ። ወአዕቀጽኮሙ ለኵሎሙ እለ ቆሙ ላዕሌየ በመትሕቴየ።" },
                    { title: "ትርጉም", main: "ለሰልፍም ኃይልን ታስታጥቀኛለህ፤ በበላዬ  የቆሙትን ሁሉ በበታቼ ታስገዛቸዋለ የጠላቶቼን ጀርባ ሰጠኸኝ፥ የሚጠሉኝንም አጠፋሃቸው። \nመዝ. 17፥39-40። " },
                    { title: "ወንጌል ማርቆስ 8 ", main: "³⁴ ሕዝቡንም ከደቀ መዛሙርቱ ጋር ጠርቶ እንዲህ አላቸው፦ በኋላዬ ሊመጣ የሚወድ ቢኖር፥ ራሱን ይካድ መስቀሉንም ተሸክሞ ይከተለኝ።\n³⁵ ነፍሱን ሊያድን የሚወድ ሁሉ ያጠፋታልና፥ ስለ እኔና ስለ ወንጌል ነፍሱን የሚያጠፋ ሁሉ ግን ያድናታል።\n³⁶ ሰው ዓለምን ሁሉ ቢያተርፍ ነፍሱንም ቢያጐድል ምን ይጠቅመዋል?\n³⁷ ሰውስ ስለ ነፍሱ ቤዛ ምን ይሰጣል?\n³⁸ በዚህም በዘማዊና በኃጢአተኛ ትውልድ መካከል በእኔና በቃሌ የሚያፍር ሁሉ፥ የሰው ልጅ ደግሞ በአባቱ ክብር ከቅዱሳን መላእክት ጋር በመጣ ጊዜ በእርሱ ያፍርበታል።" },
                    { title: "ቅዳሴ", main: "ማርያም ቅዳሴ ነው።" }
                ]
            },
            {
            ...
            },
        {
            ...
            },
            {
                ...
                content: [
                    ...
                    { title: "ምስባክ ", main: "ማእምርየ ወዐውቅየ። ዘኅቡረ አስተጠአምከ ሊተ መባልዕተ። ወነሐውር ቤተ #እግዚአብሔር በ፩ ልብ። \n" },
                    { title: "ትርጉም", main: "አንተ ግን፥ እኩያዬ ሰው፥ ባልንጀራዬና የልቤ ወዳጅ፤ መብልን ከእኔ ጋር በአንድነት ያጣፈጥህ፤ በአንድ ልብ በ #እግዚአብሔር ቤት ተራመድን።\n መዝ.54÷13-14\n" },
                    { title: "ወንጌል ማቴዎስ 19", main: "¹⁶ እነሆም፥ አንድ ሰው ቀርቦ፦ መምህር ሆይ፥ የዘላለምን ሕይወት እንዳገኝ ምን መልካም ነገር ላድርግ? አለው።\n¹⁷ እርሱም፦ ስለ መልካም ነገር ለምን ትጠይቀኛለህ? መልካም የሆነ አንድ ነው፤ ወደ ሕይወት መግባት ብትወድ ግን ትእዛዛትን ጠብቅ አለው።\n¹⁸ እርሱም፦ የትኞችን? አለው። ኢየሱስም፦ አትግደል፥ አታመንዝር፥ አትስረቅ፥ በሐሰት አትመስክር፥\n¹⁹ አባትህንና እናትህን አክብር፥ ባልንጀራህንም እንደ ራስህ ውደድ አለው።\n²⁰ ጐበዙም፦ ይህንማ ሁሉ ከሕፃንነቴ ጀምሬ ጠብቄአለሁ፥ ደግሞስ የሚጐድለኝ ምንድር ነው? አለው።\n²¹ ኢየሱስም፦ ፍጹም ልትሆን ብትወድ፥ ሂድና ያለህን ሸጠህ ለድሆች ስጥ፥ መዝገብም በሰማያት ታገኛለህ፥ መጥተህም ተከተለኝ አለው።\n²² ጐበዙም ይህን ቃል በሰማ ጊዜ ብዙ ንብረት ነበረውና እያዘነ ሄደ።\n" },
                    { title: "✝️ ቅዳሴ ", main: "#ሠለስቱ_ምዕት  ነው።" },
                ]
            },
            {
                id: 25,
...
const Gitsawe = () => {
    ...
    const getDaysForMonth = (month) => {
        if (month === "Pagume") return Array.from({ length: 6 }, (_, i) => i + 1);
